...
const features = [
  {
    name: "Intuitive Gantt Charts",
    description:
      "Visualize project timelines and dependencies with interactive Gantt charts. Easily plan and manage project schedules, ensuring tasks are completed on time.",
    icon: ChartPieIcon,
  },
  {
    name: "Collaborative Task Boards",
    description:
      "Streamline teamwork with task boards that facilitate real-time collaboration. Assign tasks, set priorities, and discuss project details within a user-friendly interface.",
    icon: RectangleStackIcon,
  },
  {
    name: "Resource Allocation",
    description:
      "Optimize resource allocation by assigning team members to tasks based on availability and skill sets. Ensure that your projects are efficiently staffed to meet deadlines.",
    icon: UserGroupIcon,
  },
  {
    name: "Advanced Reporting",
    description:
      "Gain insights into project performance with customizable reports and analytics. Track progress, identify bottlenecks, and make data-driven decisions to enhance project outcomes.",
      ...
      <div className="hero-container" id="hero">
        <div className="bg-white">
          <header className="absolute inset-x-0 top-0 z-50">
            <nav
              className="flex fixed w-full items-center justify-between p-6 lg:px-8 home-nav"
              aria-label="Global"
            >
              <div className="flex lg:flex-1">
                <a href="#" className="-m-1.5 p-1.5">
                  <span className="sr-only">PlanSail</span>
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Sail to Success with PlanSail
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Elevate Your Project Management Experience with PlanSail: Your
                  Trusted Navigator Through Every Project Challenge. Effortless
                  Collaboration, Smart Resource Allocation, and Real-Time
                  Progress Monitoring Await You.
                </p>
        ...
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Your go-to platform for all things project tracking.
                Effortlessly monitor progress, tasks, and milestones with ease,
                all in one place.
              </p>
            </div>
        ...
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Our pricing philosophy is straightforward: simplicity without
                hidden fees or gimmicks. With our transparent pricing structure,
                you'll always know what you're paying for, ensuring a
            ...
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
              <div className="p-8 sm:p-10 lg:flex-auto">
                ...
                <p className="mt-6 text-base leading-7 text-gray-600">
                  Join the PlanSail community and make a one-time commitment to
                  efficient, collaborative, and cost-effective project
                  management.
                </p>
        ...
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-600">
              Get in touch with our sales experts to unlock the power of
              PlanSail for your projects.
            </p>
          </div>
          <form
            action="#"
                ...
                <div className="relative mt-2.5">
                  <div className="absolute inset-y-0 left-0 flex items-center">
                    ...
                    <select
                      id="country"
                      name="country"
                      className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm country-code-select"
                    >
                      <option>US</option>
                      <option>CA</option>
                      <option>EU</option>
            ...
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="#" className="flex items-center">
                  <img src={Logo} className="h-8 mr-3" alt="PlanSail Logo" />
